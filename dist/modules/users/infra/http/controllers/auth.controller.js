...
const create_user_service_1 = __importDefault(require("../../../services/user/create-user.service"));
const create_user_session_service_1 = __importDefault(require("../../../services/user/create-user-session.service"));
class AuthController {
    async signUp(request, response) {
        const createUserService = tsyringe_1.container.resolve(create_user_service_1.default);
