...
import CreateStoreRatingAndNotifyCustomerService from "../../../services/store-rating-responses/create-store-rating-response.service-and-notify-customer.service";
...
class StoreRatingResponseController {
  ...
  public async create(request: Request, response: Response) {
    const createStoreRatingAndNotifyCustomerService = container.resolve(CreateStoreRatingAndNotifyCustomerService);
    const storeRating = await createStoreRatingAndNotifyCustomerService.execute(request.body);
